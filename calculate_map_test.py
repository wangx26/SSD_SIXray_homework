...
parser.add_argument('--predicted_file', default='/home/wangxu/Projects/predicted_file', type=str, help='Checkpoint state_dict file for transfer learning')
args = parser.parse_args()

annopath = os.path.join('/home/wangxu/Projects/SSD/data/sixray/Anno_test', '%s.txt')#测试集标注文件路径
test_imagesetfile = '/home/wangxu/Projects/SSD/data/sixray/core_coreless_test.txt'#测试集里面的图片名
'''
